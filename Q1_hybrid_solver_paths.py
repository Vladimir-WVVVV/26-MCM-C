...
# ==========================================
# 路径配置（仅用于本文件 main() 的演示逻辑）
# ==========================================
# 优先读取 Q1 输出（如果你想用真实数据跑某几周）
Q1_OUTPUT_PATH = r"C:\_Am\mcm_outputs\Q1_estimated_fan_votes_optimized.csv"
# 如果 Q1 输出不存在，则回退到原始官方 CSV
RAW_DATA_PATH = r"C:\_Am\Data.csv"
