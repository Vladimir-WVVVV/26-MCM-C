...
# ==========================================
# 优先读取“增强版”估计（如果你们有）
ENHANCED_PATH = r"C:\_Am\mcm_outputs\Q1_enhanced_ml_estimates.csv"
# 如果增强版不存在，则回退到 Q1 输出
FALLBACK_PATH = r"C:\_Am\mcm_outputs\Q1_estimated_fan_votes_optimized.csv"
# 输出目录
OUT_DIR = r"C:\_Am\mcm_outputs"
# 输出文件名
OUT_FILE = "Q3_factor_regression_results.csv"
