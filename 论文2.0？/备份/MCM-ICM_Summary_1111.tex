...
% Usage: \placeholderfig{Caption text}{6.0cm}{ph_task1_flow.pdf}
% Place generated figures under: figures/
\newcommand{\placeholderfig}[3]{%
    \begin{figure}[H]
        \centering
        \IfFileExists{figures/#3}{%
            \includegraphics[width=0.95\textwidth,height=#2,keepaspectratio]{figures/#3}
        }{%
            \fbox{\parbox[c][#2][c]{0.95\textwidth}{\centering\textit{Figure Placeholder}\\
            \textbf{#1}\\
            \small File to create: \texttt{\detokenize{figures/#3}} }}
        }
        \caption{#1}
    \end{figure}
}
...
\newcommand{\resultfig}[4]{%
    \begin{figure}[H]
        ...
        \IfFileExists{visualization_results/#3}{%
            \includegraphics[width=0.95\textwidth,height=#2,keepaspectratio]{visualization_results/#3}
        }{%
            \fbox{\parbox[c][#2][c]{0.95\textwidth}{\centering\textit{Figure Placeholder}\\
            \textbf{#1}\\
...
% (Enlarged) Flow overview is more readable at ~6cm height.
\placeholderfig{Overall variable relationships and four-task workflow}{6.0cm}{ph_overall_workflow.pdf}
...
% (Enlarged) Dual-engine pipeline flowchart.
\placeholderfig{Task 1: Dual-engine (MAP + MCMC) vote reconstruction pipeline}{6.2cm}{ph_task1_dual_engine_flow.pdf}
	...
	\resultfig{Distribution of reconstruction accuracy across 5 robustness trials.}{9.0cm}{Q1_Accuracy_Distribution.png}{fig:q1_accuracy}

\placeholderfig{Representative MCMC trace plot for vote-share parameters (typical week)}{9.5cm}{ph_task1_traceplot.pdf}
...
% (Enlarged) Improve readability for workflow diagram.
\placeholderfig{Task 2: Counterfactual simulation workflow (Ranking vs. Percentage)}{5.8cm}{ph_task2_simulation_flow.pdf}
...
\placeholderfig{Disagreement rate by season/week between the two aggregation methods}{8.5cm}{ph_task2_disagreement_trend.pdf}
	...
	\resultfig{Non-linear fan vote preference over age with 95\% confidence band.}{8.5cm}{Q3_Age_Curve_CI.png}{fig:q3_age}
	...
	\resultfig{Heatmap of industry bias: judge vs. fan contribution differences.}{8.5cm}{Q3_Heatmap.png}{fig:q3_heatmap}
...
% (Enlarged) Improve readability for optimization workflow diagram.
\placeholderfig{Task 4: Mechanism design and multi-objective optimization workflow}{5.8cm}{ph_task4_optimization_flow.pdf}
	...
	\resultfig{Optimization landscape of fairness vs. engagement under different weights.}{9.0cm}{Q4_Optimization_Landscape.png}{fig:q4_landscape}

\placeholderfig{Pareto frontier of (unfair elimination rate, engagement score) under candidate mechanisms}{9.5cm}{ph_task4_pareto_frontier.pdf}
...
% (Enlarged) Plate diagram needs larger height to avoid tiny node labels.
\placeholderfig{Appendix: Probabilistic graphical model / plate diagram for vote reconstruction}{6.0cm}{ph_appendix_graphical_model.pdf}
...
\bibitem{gelman1992}
A. Gelman and D. B. Rubin, “Inference from iterative simulation using multiple sequences,” \emph{Statistical Science}, vol. 7, no. 4, pp. 457–472, 1992.
