...
\placeholderfig{Overall variable relationships and four-task workflow}{4.2cm}{ph_overall_workflow.pdf}
...
\placeholderfig{Task 1: Dual-engine (MAP + MCMC) vote reconstruction pipeline}{4.4cm}{ph_task1_dual_engine_flow.pdf}
...
\placeholderfig{Task 2: Counterfactual simulation workflow (Ranking vs. Percentage)}{4.0cm}{ph_task2_simulation_flow.pdf}
...
\placeholderfig{Task 4: Mechanism design and multi-objective optimization workflow}{4.0cm}{ph_task4_optimization_flow.pdf}
...
\placeholderfig{Appendix: Probabilistic graphical model / plate diagram for vote reconstruction}{4.0cm}{ph_appendix_graphical_model.pdf}
