...
\newcommand{\placeholderfig}[3]{%
    \begin{figure}[H]
        ...
        \IfFileExists{figures/#3}{%
            \includegraphics[width=0.90\textwidth,height=#2,keepaspectratio]{figures/#3}
        }{%
...
\newcommand{\placeholderfigbig}[3]{%
    \begin{figure}[H]
        \centering
        \IfFileExists{figures/#3}{%
            \includegraphics[width=0.98\textwidth,height=#2,keepaspectratio]{figures/#3}
        }{%
...
\placeholderfigbig{Overall variable relationships and four-task workflow}{9.8cm}{ph_overall_workflow.pdf}
...
\placeholderfigbig{Task 1: Dual-engine (MAP + MCMC) vote reconstruction pipeline}{9.8cm}{ph_task1_dual_engine_flow.pdf}
...
\placeholderfigbig{Task 2: Counterfactual simulation workflow (Ranking vs. Percentage)}{9.8cm}{ph_task2_simulation_flow.pdf}
...
\placeholderfigbig{Task 4: Mechanism design and multi-objective optimization workflow}{9.8cm}{ph_task4_optimization_flow.pdf}
...
\placeholderfigbig{Appendix: Probabilistic graphical model / plate diagram for vote reconstruction}{9.8cm}{ph_appendix_graphical_model.pdf}
